...
public class StockAvg extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static hip.ch5.avro.gen.StockAvg.Builder newBuilder() {
    return new hip.ch5.avro.gen.StockAvg.Builder();
  }

  /** Creates a new StockAvg RecordBuilder by copying an existing Builder */
  public static hip.ch5.avro.gen.StockAvg.Builder newBuilder(hip.ch5.avro.gen.StockAvg.Builder other) {
    return new hip.ch5.avro.gen.StockAvg.Builder(other);
  }

  /** Creates a new StockAvg RecordBuilder by copying an existing StockAvg instance */
  public static hip.ch5.avro.gen.StockAvg.Builder newBuilder(hip.ch5.avro.gen.StockAvg other) {
    return new hip.ch5.avro.gen.StockAvg.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StockAvg>
    ...
    private Builder() {
      super(hip.ch5.avro.gen.StockAvg.SCHEMA$);
    }

    /** Creates a Builder by copying an existing Builder */
    private Builder(hip.ch5.avro.gen.StockAvg.Builder other) {
      super(other);
    }

    /** Creates a Builder by copying an existing StockAvg instance */
    private Builder(hip.ch5.avro.gen.StockAvg other) {
            super(hip.ch5.avro.gen.StockAvg.SCHEMA$);
    ...
    /** Sets the value of the 'symbol' field */
    public hip.ch5.avro.gen.StockAvg.Builder setSymbol(CharSequence value) {
    ...
    public hip.ch5.avro.gen.StockAvg.Builder clearSymbol() {
      symbol = null;
    ...
    /** Sets the value of the 'avg' field */
    public hip.ch5.avro.gen.StockAvg.Builder setAvg(double value) {
    ...
    public hip.ch5.avro.gen.StockAvg.Builder clearAvg() {
