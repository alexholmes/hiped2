...
public class SimpleRepartitionMapReduce2 extends Configured implements Tool {
  ...
  public static void main(final String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(), new SimpleRepartitionMapReduce2(), args);
    System.exit(res);
  }
